...
👉 [@meshtastic64](https://t.me/meshtastic64) Прочти обязательно: [правила чата](/docs/сhat_rules.md).
...
- [Прошить оф. сайт]([https://meshtastic-alt.ru/](https://flasher.meshtastic.org/)) или [зеркало](https://meshtastic-alt.ru/)
...
### Приложения:
Google Pay и App Store приложение не доступно, скачать для Android можно из [официального репозитория](https://github.com/meshtastic/Meshtastic-Android/releases).
